...
const SAMPLE_SESSION_JSONL = [
  '{"timestamp":0.00,"groundTruth":"NORMAL_WORK","cameraState":"VALID","confidence":0.96,"features":{"shoulderTilt":1.4,"headXOffset":0.02,"headYOffset":0.01,"bodyScale":1.00,"motionEnergy":0.05}}',
  '{"timestamp":1.00,"groundTruth":"NORMAL_WORK","cameraState":"VALID","confidence":0.95,"features":{"shoulderTilt":1.6,"headXOffset":0.03,"headYOffset":0.02,"bodyScale":1.01,"motionEnergy":0.06}}',
  '{"timestamp":31.42,"groundTruth":"NORMAL_WORK","cameraState":"VALID","confidence":0.94,"features":{"shoulderTilt":2.1,"headXOffset":0.06,"headYOffset":0.93,"bodyScale":1.04,"motionEnergy":0.12}}',
  '{"timestamp":45.00,"groundTruth":"FORWARD_LEAN","cameraState":"VALID","confidence":0.93,"features":{"shoulderTilt":3.2,"headXOffset":0.05,"headYOffset":0.30,"bodyScale":1.10,"motionEnergy":0.08}}',
  '{"timestamp":60.00,"groundTruth":"NORMAL_WORK","cameraState":"VALID","confidence":0.95,"features":{"shoulderTilt":1.5,"headXOffset":0.02,"headYOffset":0.01,"bodyScale":1.00,"motionEnergy":0.04}}',
].join("\n");

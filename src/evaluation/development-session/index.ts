...
export const STANDARD_DEVELOPMENT_SESSION: readonly DevelopmentSessionStep[] = [
  ...
  { atSeconds: 25, action: "SCENARIO_STARTED", label: "FORWARD_HEAD" },
  { atSeconds: 28, action: "DRIFT_ONSET", label: "FORWARD_HEAD" },
  { atSeconds: 38, action: "SCENARIO_ENDED", label: "FORWARD_HEAD" },

...
> - 1,2주차에 게임을 개발해서 다른 분야의 주제를 하고 싶던 와중, Mediapipe를 사용하여 자세를 판별하는 처음 경험해보는 분야의 주제를 진행하게 되어 좋았습니다. 비록 중간에 기획서를 수정하고, 처음에 목표로 세웠던 기능을 완전히 구현하지 못하거나 포기하게 되어서 힘들었지만, 그와 동시에 시행착오에서 배울 수 있는 여러 점들을 몸소 느낄 수 있어 유익했습니다.
